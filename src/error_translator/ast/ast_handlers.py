...
def handle_name_error(file_path: str, extracted_values: list) -> str:
    ...
    suggestion = get_ast_suggestions(file_path, bad_name, "NameError")
...
def handle_attribute_error(file_path: str, extracted_values: list) -> str:
    ...
    suggestion = get_ast_suggestions(file_path, bad_attr, "AttributeError")
    if suggestion:
...
def handle_import_error(file_path: str, extracted_values: list) -> str:
   ...
   suggestion = get_ast_suggestions(file_path, bad_name, "ImportError")
   if suggestion:
